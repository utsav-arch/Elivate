            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <Card className="p-4 bg-slate-50">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <Badge className={`px-3 py-1 ${
                        ...
                        customer.account_status === 'UAT' ? 'bg-purple-100 text-purple-700' :
                        'bg-orange-100 text-orange-700'
                      }`}>
                        {customer.account_status || 'Live'}
                      </Badge>
                      <p className="text-xs text-slate-500 mt-2">
                        Account status can only be changed from this section
                      </p>
                    </div>
                    <Button
                  ...
                  {customer.account_status === 'Churn' && (
                    <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded-lg">
                      <div className="flex items-start space-x-2">
                        <AlertTriangle size={18} className="text-red-600 mt-0.5" />
                        <div>
                          <p className="font-medium text-red-700">Account Churned</p>
                          <p className="text-sm text-red-600">
                            This account has been marked as churned. Status cannot be changed.
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-semibold text-slate-800">Contract Information</h3>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => openEditForm('basic')}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <Card className="p-4">
                    <p className="text-sm text-slate-600 mb-1">Contract Start Date</p>
                    <p className="font-medium text-slate-800">
                      {customer.contract_start_date ? new Date(customer.contract_start_date).toLocaleDateString('en-IN') : 'Not set'}
                    </p>
                  </Card>
                  <Card className="p-4">
                    <p className="text-sm text-slate-600 mb-1">Contract End Date</p>
                    <p className="font-medium text-slate-800">
                      {customer.contract_end_date ? new Date(customer.contract_end_date).toLocaleDateString('en-IN') : 'Not set'}
                    </p>
                  </Card>
                  <Card className="p-4">
                    <p className="text-sm text-slate-600 mb-1">Renewal Date</p>
                    <p className="font-medium text-slate-800">
                      {customer.renewal_date ? new Date(customer.renewal_date).toLocaleDateString('en-IN') : 'Not set'}
                    </p>
                  </Card>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-semibold text-slate-800">Account Ownership</h3>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => openEditForm('users')}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Card className="p-4">
                    <p className="text-sm text-slate-600 mb-1">CSM Owner</p>
                    <p className="font-medium text-slate-800">{customer.csm_owner_name || 'Unassigned'}</p>
                  </Card>
                  <Card className="p-4">
                    <p className="text-sm text-slate-600 mb-1">AM Owner</p>
                    <p className="font-medium text-slate-800">{customer.am_owner_name || 'Unassigned'}</p>
                  </Card>
                </div>
              </div>
              ...
              {/* Tags */}
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-slate-800">Account Tags</h3>
